...
abstract class AbstractAction extends \Magento\Backend\App\Action
{
     ...
     * Slider factory.
     *
     * @var \Waghron\Collections\Model\SliderFactory
     */
     ...
     * @param \Waghron\Collections\Model\SliderFactory $sliderFactory
    ...
    public function __construct(
        ...
        \Waghron\Collections\Model\SliderFactory $sliderFactory,
    ...
    protected function _createMainCollection()
    {
        ...
        $collection = $this->_objectManager->create('Waghron\Collections\Model\ResourceModel\Slide\Collection');
        return $collection;
    }
